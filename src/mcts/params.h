...
class SearchParams {
 public:
  ...
  float GetAuxEngineForceVisitsRatioMiniMax() const {
    return options_.Get<float>(kAuxEngineForceVisitsRatioMiniMaxId);
  }
  ...
  static const OptionId kAuxEngineForceVisitsRatioMiniMaxId;
